    ...
    return (
      ...
      <div>
        <div className=" h-[600px] bg-[#F4F3F0] ">
            <p className="text-black flex justify-center text-3xl font-mono font-extrabold">Update  Coffee</p>
            ...
            <form onSubmit={handelAddCoffee}>
                <div className="flex justify-center mb-8">
                  ...
                  <input type="text" placeholder="Type here" defaultValue={chef} name="chef" className="input input-bordered w-full max-w-xs" />
                  </div>
                </div>
                <div className="flex justify-around mb-8">
                  <div className="  md:w-1/2">
                  <h1 className=" text-lg font-bold font-serif">Supplier</h1>
                  <input type="text" placeholder="Type here" defaultValue={supplier} name="supplier" className="input input-bordered w-full max-w-xs" />
                  </div>
                  <div  className="w-1/2">
                ...
                <div className="flex justify-around mb-8">
                  ...
                  <input type="text" placeholder="Type here" defaultValue={category} name="category" className="input input-bordered w-full max-w-xs" />
                  </div>
                  <div  className="w-1/2">
